"""
Django settings for django_for_jenkins project.
...
SECRET_KEY = '$5urm8mv1s79gi&g@1cg-r62v%a@+82gq!0*poxj3f^pawhvmm'
...
ROOT_URLCONF = 'django_for_jenkins.urls'
...
WSGI_APPLICATION = 'django_for_jenkins.wsgi.application'
